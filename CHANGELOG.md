...
- A new cycle can no longer start out of the post-cycle phase — that phase's draw can exceed `start_threshold`, which would flap between the two states. Use the reset button if a new load is started before the appliance goes quiet.
